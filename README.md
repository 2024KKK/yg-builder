<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/badge/topspeed--builder-v1.0.2-00d4ff?style=flat-square&labelColor=0b0e11">
    <img src="https://img.shields.io/badge/topspeed--builder-v1.0.2-00d4ff?style=flat-square&labelColor=0b0e11" alt="版本">
  </picture>
</p>
...
一键安装包位于 `release/Topspeed Builder Setup 1.0.2.exe`。
...
One-click installer at `release/Topspeed Builder Setup 1.0.2.exe`.
